 ...
 */
public class VelocityMeasureTypeImpl extends org.apache.xmlbeans.impl.values.JavaDoubleHolderEx implements gov.ucore.ucore.x20.VelocityMeasureType
{
    ...
    protected VelocityMeasureTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
     ...
     */
    public gov.ucore.ucore.x20.VelocityUOMType.Enum getVelocityUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (gov.ucore.ucore.x20.VelocityUOMType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.ucore.ucore.x20.VelocityUOMType xgetVelocityUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore.x20.VelocityUOMType target = null;
            target = (gov.ucore.ucore.x20.VelocityUOMType)get_store().find_attribute_user(VELOCITYUOM$40);
            return target;
        }
    }
     ...
     */
    public void setVelocityUOM(gov.ucore.ucore.x20.VelocityUOMType.Enum velocityUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetVelocityUOM(gov.ucore.ucore.x20.VelocityUOMType velocityUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore.x20.VelocityUOMType)get_store().add_attribute_user(VELOCITYUOM$40);
            }
