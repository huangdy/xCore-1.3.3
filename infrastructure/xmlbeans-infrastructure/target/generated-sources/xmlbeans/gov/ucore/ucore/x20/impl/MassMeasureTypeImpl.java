 ...
 */
public class MassMeasureTypeImpl extends org.apache.xmlbeans.impl.values.JavaDoubleHolderEx implements gov.ucore.ucore.x20.MassMeasureType
{
    ...
    protected MassMeasureTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
    ...
    public usGovIcIsmV2.ClassificationType xgetClassification()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.ClassificationType)get_store().find_attribute_user(CLASSIFICATION$2);
            return target;
        }
    }
    ...
    public void xsetClassification(usGovIcIsmV2.ClassificationType classification)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.ClassificationType)get_store().add_attribute_user(CLASSIFICATION$2);
            }
    ...
    public usGovIcIsmV2.OwnerProducerAttribute.OwnerProducer xgetOwnerProducer()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.OwnerProducerAttribute.OwnerProducer)get_store().find_attribute_user(OWNERPRODUCER$4);
            return target;
        }
    }
    ...
    public void xsetOwnerProducer(usGovIcIsmV2.OwnerProducerAttribute.OwnerProducer ownerProducer)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.OwnerProducerAttribute.OwnerProducer)get_store().add_attribute_user(OWNERPRODUCER$4);
            }
    ...
    public usGovIcIsmV2.SCIcontrolsAttribute.SCIcontrols xgetSCIcontrols()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.SCIcontrolsAttribute.SCIcontrols)get_store().find_attribute_user(SCICONTROLS$6);
            return target;
        }
    }
    ...
    public void xsetSCIcontrols(usGovIcIsmV2.SCIcontrolsAttribute.SCIcontrols scIcontrols)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.SCIcontrolsAttribute.SCIcontrols)get_store().add_attribute_user(SCICONTROLS$6);
            }
    ...
    public usGovIcIsmV2.SARIdentifierAttribute.SARIdentifier xgetSARIdentifier()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.SARIdentifierAttribute.SARIdentifier)get_store().find_attribute_user(SARIDENTIFIER$8);
            return target;
        }
    }
    ...
    public void xsetSARIdentifier(usGovIcIsmV2.SARIdentifierAttribute.SARIdentifier sarIdentifier)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.SARIdentifierAttribute.SARIdentifier)get_store().add_attribute_user(SARIDENTIFIER$8);
            }
    ...
    public usGovIcIsmV2.DisseminationControlsAttribute.DisseminationControls xgetDisseminationControls()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DisseminationControlsAttribute.DisseminationControls)get_store().find_attribute_user(DISSEMINATIONCONTROLS$10);
            return target;
        }
    }
    ...
    public void xsetDisseminationControls(usGovIcIsmV2.DisseminationControlsAttribute.DisseminationControls disseminationControls)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DisseminationControlsAttribute.DisseminationControls)get_store().add_attribute_user(DISSEMINATIONCONTROLS$10);
            }
    ...
    public usGovIcIsmV2.FGIsourceOpenAttribute.FGIsourceOpen xgetFGIsourceOpen()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.FGIsourceOpenAttribute.FGIsourceOpen)get_store().find_attribute_user(FGISOURCEOPEN$12);
            return target;
        }
    }
    ...
    public void xsetFGIsourceOpen(usGovIcIsmV2.FGIsourceOpenAttribute.FGIsourceOpen fgIsourceOpen)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.FGIsourceOpenAttribute.FGIsourceOpen)get_store().add_attribute_user(FGISOURCEOPEN$12);
            }
    ...
    public usGovIcIsmV2.FGIsourceProtectedAttribute.FGIsourceProtected xgetFGIsourceProtected()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.FGIsourceProtectedAttribute.FGIsourceProtected)get_store().find_attribute_user(FGISOURCEPROTECTED$14);
            return target;
        }
    }
    ...
    public void xsetFGIsourceProtected(usGovIcIsmV2.FGIsourceProtectedAttribute.FGIsourceProtected fgIsourceProtected)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.FGIsourceProtectedAttribute.FGIsourceProtected)get_store().add_attribute_user(FGISOURCEPROTECTED$14);
            }
    ...
    public usGovIcIsmV2.ReleasableToAttribute.ReleasableTo xgetReleasableTo()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.ReleasableToAttribute.ReleasableTo)get_store().find_attribute_user(RELEASABLETO$16);
            return target;
        }
    }
    ...
    public void xsetReleasableTo(usGovIcIsmV2.ReleasableToAttribute.ReleasableTo releasableTo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.ReleasableToAttribute.ReleasableTo)get_store().add_attribute_user(RELEASABLETO$16);
            }
    ...
    public usGovIcIsmV2.NonICmarkingsAttribute.NonICmarkings xgetNonICmarkings()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.NonICmarkingsAttribute.NonICmarkings)get_store().find_attribute_user(NONICMARKINGS$18);
            return target;
        }
    }
    ...
    public void xsetNonICmarkings(usGovIcIsmV2.NonICmarkingsAttribute.NonICmarkings nonICmarkings)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.NonICmarkingsAttribute.NonICmarkings)get_store().add_attribute_user(NONICMARKINGS$18);
            }
    ...
    public usGovIcIsmV2.ClassifiedByAttribute.ClassifiedBy xgetClassifiedBy()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.ClassifiedByAttribute.ClassifiedBy)get_store().find_attribute_user(CLASSIFIEDBY$20);
            return target;
        }
    }
    ...
    public void xsetClassifiedBy(usGovIcIsmV2.ClassifiedByAttribute.ClassifiedBy classifiedBy)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.ClassifiedByAttribute.ClassifiedBy)get_store().add_attribute_user(CLASSIFIEDBY$20);
            }
    ...
    public usGovIcIsmV2.DerivativelyClassifiedByAttribute.DerivativelyClassifiedBy xgetDerivativelyClassifiedBy()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DerivativelyClassifiedByAttribute.DerivativelyClassifiedBy)get_store().find_attribute_user(DERIVATIVELYCLASSIFIEDBY$22);
            return target;
        }
    }
    ...
    public void xsetDerivativelyClassifiedBy(usGovIcIsmV2.DerivativelyClassifiedByAttribute.DerivativelyClassifiedBy derivativelyClassifiedBy)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DerivativelyClassifiedByAttribute.DerivativelyClassifiedBy)get_store().add_attribute_user(DERIVATIVELYCLASSIFIEDBY$22);
            }
    ...
    public usGovIcIsmV2.ClassificationReasonAttribute.ClassificationReason xgetClassificationReason()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.ClassificationReasonAttribute.ClassificationReason)get_store().find_attribute_user(CLASSIFICATIONREASON$24);
            return target;
        }
    }
    ...
    public void xsetClassificationReason(usGovIcIsmV2.ClassificationReasonAttribute.ClassificationReason classificationReason)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.ClassificationReasonAttribute.ClassificationReason)get_store().add_attribute_user(CLASSIFICATIONREASON$24);
            }
    ...
    public usGovIcIsmV2.DerivedFromAttribute.DerivedFrom xgetDerivedFrom()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DerivedFromAttribute.DerivedFrom)get_store().find_attribute_user(DERIVEDFROM$26);
            return target;
        }
    }
    ...
    public void xsetDerivedFrom(usGovIcIsmV2.DerivedFromAttribute.DerivedFrom derivedFrom)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DerivedFromAttribute.DerivedFrom)get_store().add_attribute_user(DERIVEDFROM$26);
            }
    ...
    public usGovIcIsmV2.DeclassDateAttribute.DeclassDate xgetDeclassDate()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DeclassDateAttribute.DeclassDate)get_store().find_attribute_user(DECLASSDATE$28);
            return target;
        }
    }
    ...
    public void xsetDeclassDate(usGovIcIsmV2.DeclassDateAttribute.DeclassDate declassDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DeclassDateAttribute.DeclassDate)get_store().add_attribute_user(DECLASSDATE$28);
            }
    ...
    public usGovIcIsmV2.DeclassEventAttribute.DeclassEvent xgetDeclassEvent()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DeclassEventAttribute.DeclassEvent)get_store().find_attribute_user(DECLASSEVENT$30);
            return target;
        }
    }
    ...
    public void xsetDeclassEvent(usGovIcIsmV2.DeclassEventAttribute.DeclassEvent declassEvent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DeclassEventAttribute.DeclassEvent)get_store().add_attribute_user(DECLASSEVENT$30);
            }
    ...
    public usGovIcIsmV2.DeclassExceptionAttribute.DeclassException xgetDeclassException()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DeclassExceptionAttribute.DeclassException)get_store().find_attribute_user(DECLASSEXCEPTION$32);
            return target;
        }
    }
    ...
    public void xsetDeclassException(usGovIcIsmV2.DeclassExceptionAttribute.DeclassException declassException)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DeclassExceptionAttribute.DeclassException)get_store().add_attribute_user(DECLASSEXCEPTION$32);
            }
    ...
    public usGovIcIsmV2.TypeOfExemptedSourceAttribute.TypeOfExemptedSource xgetTypeOfExemptedSource()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.TypeOfExemptedSourceAttribute.TypeOfExemptedSource)get_store().find_attribute_user(TYPEOFEXEMPTEDSOURCE$34);
            return target;
        }
    }
    ...
    public void xsetTypeOfExemptedSource(usGovIcIsmV2.TypeOfExemptedSourceAttribute.TypeOfExemptedSource typeOfExemptedSource)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.TypeOfExemptedSourceAttribute.TypeOfExemptedSource)get_store().add_attribute_user(TYPEOFEXEMPTEDSOURCE$34);
            }
    ...
    public usGovIcIsmV2.DateOfExemptedSourceAttribute.DateOfExemptedSource xgetDateOfExemptedSource()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DateOfExemptedSourceAttribute.DateOfExemptedSource)get_store().find_attribute_user(DATEOFEXEMPTEDSOURCE$36);
            return target;
        }
    }
    ...
    public void xsetDateOfExemptedSource(usGovIcIsmV2.DateOfExemptedSourceAttribute.DateOfExemptedSource dateOfExemptedSource)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DateOfExemptedSourceAttribute.DateOfExemptedSource)get_store().add_attribute_user(DATEOFEXEMPTEDSOURCE$36);
            }
    ...
    public usGovIcIsmV2.DeclassManualReviewAttribute.DeclassManualReview xgetDeclassManualReview()
    {
        synchronized (monitor())
        {
            ...
            target = (usGovIcIsmV2.DeclassManualReviewAttribute.DeclassManualReview)get_store().find_attribute_user(DECLASSMANUALREVIEW$38);
            return target;
        }
    }
    ...
    public void xsetDeclassManualReview(usGovIcIsmV2.DeclassManualReviewAttribute.DeclassManualReview declassManualReview)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (usGovIcIsmV2.DeclassManualReviewAttribute.DeclassManualReview)get_store().add_attribute_user(DECLASSMANUALREVIEW$38);
            }
     ...
     */
    public gov.ucore.ucore.x20.MassUOMType.Enum getMassUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (gov.ucore.ucore.x20.MassUOMType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.ucore.ucore.x20.MassUOMType xgetMassUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore.x20.MassUOMType target = null;
            target = (gov.ucore.ucore.x20.MassUOMType)get_store().find_attribute_user(MASSUOM$40);
            return target;
        }
    }
     ...
     */
    public void setMassUOM(gov.ucore.ucore.x20.MassUOMType.Enum massUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetMassUOM(gov.ucore.ucore.x20.MassUOMType massUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore.x20.MassUOMType)get_store().add_attribute_user(MASSUOM$40);
            }
            target.set(massUOM);
        }
    }
