 ...
 */
public class AngleMeasureTypeImpl extends org.apache.xmlbeans.impl.values.JavaDoubleHolderEx implements gov.ucore.ucore.x20.AngleMeasureType
{
    ...
    protected AngleMeasureTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
     ...
     */
    public gov.ucore.ucore.x20.AngleUOMType.Enum getAngleUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (gov.ucore.ucore.x20.AngleUOMType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.ucore.ucore.x20.AngleUOMType xgetAngleUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore.x20.AngleUOMType target = null;
            target = (gov.ucore.ucore.x20.AngleUOMType)get_store().find_attribute_user(ANGLEUOM$40);
            return target;
        }
    }
     ...
     */
    public void setAngleUOM(gov.ucore.ucore.x20.AngleUOMType.Enum angleUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetAngleUOM(gov.ucore.ucore.x20.AngleUOMType angleUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore.x20.AngleUOMType)get_store().add_attribute_user(ANGLEUOM$40);
            }
            target.set(angleUOM);
        }
    }
