 ...
 */
public class DisseminationCriteriaDocumentImpl extends x0.messageStructure1.impl.DisseminationCriteriaAbstractDocumentImpl implements gov.ucore.ucore.x20.DisseminationCriteriaDocument
{
     ...
     */
    public gov.ucore.ucore.x20.DisseminationCriteriaDocument.DisseminationCriteria getDisseminationCriteria()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore.x20.DisseminationCriteriaDocument.DisseminationCriteria target = null;
            target = (gov.ucore.ucore.x20.DisseminationCriteriaDocument.DisseminationCriteria)get_store().find_element_user(DISSEMINATIONCRITERIA$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDisseminationCriteria(gov.ucore.ucore.x20.DisseminationCriteriaDocument.DisseminationCriteria disseminationCriteria)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore.x20.DisseminationCriteriaDocument.DisseminationCriteria)get_store().add_element_user(DISSEMINATIONCRITERIA$0);
            }
     ...
     */
    public gov.ucore.ucore.x20.DisseminationCriteriaDocument.DisseminationCriteria addNewDisseminationCriteria()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class DisseminationCriteriaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.ucore.ucore.x20.DisseminationCriteriaDocument.DisseminationCriteria
    {
        private static final long serialVersionUID = 1L;
