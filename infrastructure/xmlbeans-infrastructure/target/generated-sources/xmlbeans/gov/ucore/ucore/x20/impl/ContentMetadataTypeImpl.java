 ...
 */
public class ContentMetadataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.ucore.ucore.x20.ContentMetadataType
{
     ...
     */
    public gov.ucore.ucore.x20.StringType getComment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore.x20.StringType target = null;
            target = (gov.ucore.ucore.x20.StringType)get_store().find_element_user(COMMENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setComment(gov.ucore.ucore.x20.StringType comment)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore.x20.StringType)get_store().add_element_user(COMMENT$0);
            }
            target.set(comment);
        }
    }
     ...
     */
    public gov.ucore.ucore.x20.StringType addNewComment()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms.x20.PublisherType getInformationSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms.x20.PublisherType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms.x20.PublisherType)get_store().find_element_user(INFORMATIONSOURCE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setInformationSource(mil.dod.metadata.mdr.ns.ddms.x20.PublisherType informationSource)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms.x20.PublisherType)get_store().add_element_user(INFORMATIONSOURCE$2);
            }
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms.x20.PublisherType addNewInformationSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.ucore.ucore.x20.TimeType getValidityTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore.x20.TimeType target = null;
            target = (gov.ucore.ucore.x20.TimeType)get_store().find_element_user(VALIDITYTIME$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setValidityTime(gov.ucore.ucore.x20.TimeType validityTime)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore.x20.TimeType)get_store().add_element_user(VALIDITYTIME$4);
            }
     ...
     */
    public gov.ucore.ucore.x20.TimeType addNewValidityTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
