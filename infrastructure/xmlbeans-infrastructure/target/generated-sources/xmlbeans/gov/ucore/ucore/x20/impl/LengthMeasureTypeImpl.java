 ...
 */
public class LengthMeasureTypeImpl extends org.apache.xmlbeans.impl.values.JavaDoubleHolderEx implements gov.ucore.ucore.x20.LengthMeasureType
{
     ...
     */
    public gov.ucore.ucore.x20.LengthUOMType.Enum getLengthUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (gov.ucore.ucore.x20.LengthUOMType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.ucore.ucore.x20.LengthUOMType xgetLengthUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore.x20.LengthUOMType target = null;
            target = (gov.ucore.ucore.x20.LengthUOMType)get_store().find_attribute_user(LENGTHUOM$40);
            return target;
        }
    }
     ...
     */
    public void setLengthUOM(gov.ucore.ucore.x20.LengthUOMType.Enum lengthUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetLengthUOM(gov.ucore.ucore.x20.LengthUOMType lengthUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore.x20.LengthUOMType)get_store().add_attribute_user(LENGTHUOM$40);
            }
