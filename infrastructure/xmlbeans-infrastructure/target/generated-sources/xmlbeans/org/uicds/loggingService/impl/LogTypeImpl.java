 ...
 */
public class LogTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.uicds.loggingService.LogType
{
    ...
    private static final javax.xml.namespace.QName TIMESTAMP$2 = 
        new javax.xml.namespace.QName("http://uicds.org/LoggingService", "timestamp");
    ...
    private static final javax.xml.namespace.QName TYPE$6 = 
        new javax.xml.namespace.QName("http://uicds.org/LoggingService", "type");
    private static final javax.xml.namespace.QName MESSAGE$8 = 
        new javax.xml.namespace.QName("http://uicds.org/LoggingService", "message");
     ...
     */
    public org.uicds.loggingService.LogLevelType.Enum getType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (org.uicds.loggingService.LogLevelType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.uicds.loggingService.LogLevelType xgetType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.uicds.loggingService.LogLevelType target = null;
            target = (org.uicds.loggingService.LogLevelType)get_store().find_element_user(TYPE$6, 0);
            return target;
        }
    }
     ...
     */
    public void setType(org.uicds.loggingService.LogLevelType.Enum type)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetType(org.uicds.loggingService.LogLevelType type)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.uicds.loggingService.LogLevelType)get_store().add_element_user(TYPE$6);
            }
            target.set(type);
        }
    }
