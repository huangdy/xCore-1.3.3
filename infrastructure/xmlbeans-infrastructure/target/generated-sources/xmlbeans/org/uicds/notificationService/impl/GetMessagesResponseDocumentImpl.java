 ...
 */
public class GetMessagesResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.uicds.notificationService.GetMessagesResponseDocument
{
    ...
    private static final javax.xml.namespace.QName GETMESSAGESRESPONSE$0 = 
        new javax.xml.namespace.QName("http://uicds.org/NotificationService", "GetMessagesResponse");
    
    
    /**
     * Gets the "GetMessagesResponse" element
     */
    public org.uicds.notificationService.GetMessagesResponseDocument.GetMessagesResponse getGetMessagesResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.uicds.notificationService.GetMessagesResponseDocument.GetMessagesResponse target = null;
            target = (org.uicds.notificationService.GetMessagesResponseDocument.GetMessagesResponse)get_store().find_element_user(GETMESSAGESRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetMessagesResponse(org.uicds.notificationService.GetMessagesResponseDocument.GetMessagesResponse getMessagesResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.uicds.notificationService.GetMessagesResponseDocument.GetMessagesResponse)get_store().add_element_user(GETMESSAGESRESPONSE$0);
            }
     ...
     */
    public org.uicds.notificationService.GetMessagesResponseDocument.GetMessagesResponse addNewGetMessagesResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetMessagesResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.uicds.notificationService.GetMessagesResponseDocument.GetMessagesResponse
    {
        private static final long serialVersionUID = 1L;
