 ...
 */
public class FacilityIdentifierDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms.x20.FacilityIdentifierDocument
{
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms.x20.FacilityIdentifierType getFacilityIdentifier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms.x20.FacilityIdentifierType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms.x20.FacilityIdentifierType)get_store().find_element_user(FACILITYIDENTIFIER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFacilityIdentifier(mil.dod.metadata.mdr.ns.ddms.x20.FacilityIdentifierType facilityIdentifier)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms.x20.FacilityIdentifierType)get_store().add_element_user(FACILITYIDENTIFIER$0);
            }
