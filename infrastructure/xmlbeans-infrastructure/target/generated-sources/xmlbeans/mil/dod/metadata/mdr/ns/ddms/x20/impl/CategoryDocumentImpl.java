 ...
 */
public class CategoryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms.x20.CategoryDocument
{
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms.x20.CompoundCategoryIdentifierType getCategory()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms.x20.CompoundCategoryIdentifierType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms.x20.CompoundCategoryIdentifierType)get_store().find_element_user(CATEGORY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCategory(mil.dod.metadata.mdr.ns.ddms.x20.CompoundCategoryIdentifierType category)
    {
        synchronized (monitor())
        {
            check_orphaned();
