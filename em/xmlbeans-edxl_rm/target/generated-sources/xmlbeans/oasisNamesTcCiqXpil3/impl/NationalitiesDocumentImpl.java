 ...
 */
public class NationalitiesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements oasisNamesTcCiqXpil3.NationalitiesDocument
{
    private static final long serialVersionUID = 1L;
    
    public NationalitiesDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName NATIONALITIES$0 = 
        new javax.xml.namespace.QName("urn:oasis:names:tc:ciq:xpil:3", "Nationalities");
    
    
    /**
     * Gets the "Nationalities" element
     */
    public oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities getNationalities()
    {
        synchronized (monitor())
        {
            check_orphaned();
            oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities target = null;
            target = (oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities)get_store().find_element_user(NATIONALITIES$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setNationalities(oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities nationalities)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities)get_store().add_element_user(NATIONALITIES$0);
            }
            target.set(nationalities);
        }
    }
     ...
     */
    public oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities addNewNationalities()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class NationalitiesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities
    {
        private static final long serialVersionUID = 1L;
        
        public NationalitiesImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
         ...
         */
        public oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country[] getCountryArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country[] result = new oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country[targetList.size()];
         ...
         */
        public oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country getCountryArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country target = null;
                target = (oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country)get_store().find_element_user(COUNTRY$0, i);
                if (target == null)
                {
         ...
         */
        public void setCountryArray(oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country[] countryArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setCountryArray(int i, oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country country)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country insertNewCountry(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country target = null;
                target = (oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country)get_store().insert_element_user(COUNTRY$0, i);
                return target;
            }
        }
         ...
         */
        public oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country addNewCountry()
        {
            synchronized (monitor())
            {
                check_orphaned();
                oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country target = null;
                target = (oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country)get_store().add_element_user(COUNTRY$0);
                return target;
            }
        }
         ...
         * This is a complex type.
         */
        public static class CountryImpl extends oasisNamesTcCiqXal3.impl.CountryTypeImpl implements oasisNamesTcCiqXpil3.NationalitiesDocument.Nationalities.Country
        {
            private static final long serialVersionUID = 1L;
             ...
             */
            public oasisNamesTcCiqXpil3.NationalityTypeList xgetType()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    oasisNamesTcCiqXpil3.NationalityTypeList target = null;
                    target = (oasisNamesTcCiqXpil3.NationalityTypeList)get_store().find_attribute_user(TYPE$0);
                    return target;
                }
            }
             ...
             */
            public void xsetType(oasisNamesTcCiqXpil3.NationalityTypeList type)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (oasisNamesTcCiqXpil3.NationalityTypeList)get_store().add_attribute_user(TYPE$0);
                    }
                    target.set(type);
                }
            }
