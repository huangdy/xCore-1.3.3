 ...
 */
public class AppliesToDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.appinfo.x20.AppliesToDocument
{
     ...
     */
    public gov.niem.niem.appinfo.x20.AppliesToDocument.AppliesTo getAppliesTo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.appinfo.x20.AppliesToDocument.AppliesTo target = null;
            target = (gov.niem.niem.appinfo.x20.AppliesToDocument.AppliesTo)get_store().find_element_user(APPLIESTO$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAppliesTo(gov.niem.niem.appinfo.x20.AppliesToDocument.AppliesTo appliesTo)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.appinfo.x20.AppliesToDocument.AppliesTo)get_store().add_element_user(APPLIESTO$0);
            }
     ...
     */
    public gov.niem.niem.appinfo.x20.AppliesToDocument.AppliesTo addNewAppliesTo()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class AppliesToImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.appinfo.x20.AppliesToDocument.AppliesTo
    {
        private static final long serialVersionUID = 1L;
