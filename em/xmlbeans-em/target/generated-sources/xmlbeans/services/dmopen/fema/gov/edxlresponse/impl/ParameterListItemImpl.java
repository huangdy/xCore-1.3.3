 ...
 */
public class ParameterListItemImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements services.dmopen.fema.gov.edxlresponse.ParameterListItem
{
    ...
    private static final javax.xml.namespace.QName PARAMETERNAME$0 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/edxlresponse", "parameterName");
    private static final javax.xml.namespace.QName PARAMETERVALUE$2 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/edxlresponse", "parameterValue");
    private static final javax.xml.namespace.QName SUBPARALISTITEM$4 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/edxlresponse", "subParaListItem");
     ...
     */
    public services.dmopen.fema.gov.edxlresponse.SubParameterListItem[] getSubParaListItemArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            services.dmopen.fema.gov.edxlresponse.SubParameterListItem[] result = new services.dmopen.fema.gov.edxlresponse.SubParameterListItem[targetList.size()];
     ...
     */
    public services.dmopen.fema.gov.edxlresponse.SubParameterListItem getSubParaListItemArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.edxlresponse.SubParameterListItem target = null;
            target = (services.dmopen.fema.gov.edxlresponse.SubParameterListItem)get_store().find_element_user(SUBPARALISTITEM$4, i);
            if (target == null)
            {
     ...
     */
    public void setSubParaListItemArray(services.dmopen.fema.gov.edxlresponse.SubParameterListItem[] subParaListItemArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setSubParaListItemArray(int i, services.dmopen.fema.gov.edxlresponse.SubParameterListItem subParaListItem)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public services.dmopen.fema.gov.edxlresponse.SubParameterListItem insertNewSubParaListItem(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.edxlresponse.SubParameterListItem target = null;
            target = (services.dmopen.fema.gov.edxlresponse.SubParameterListItem)get_store().insert_element_user(SUBPARALISTITEM$4, i);
            return target;
        }
    }
     ...
     */
    public services.dmopen.fema.gov.edxlresponse.SubParameterListItem addNewSubParaListItem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.edxlresponse.SubParameterListItem target = null;
            target = (services.dmopen.fema.gov.edxlresponse.SubParameterListItem)get_store().add_element_user(SUBPARALISTITEM$4);
            return target;
        }
    }
