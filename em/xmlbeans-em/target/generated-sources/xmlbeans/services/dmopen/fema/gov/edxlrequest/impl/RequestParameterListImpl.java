 ...
 */
public class RequestParameterListImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements services.dmopen.fema.gov.edxlrequest.RequestParameterList
{
    ...
    private static final javax.xml.namespace.QName REQUESTAPI$0 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/edxlrequest", "requestAPI");
    private static final javax.xml.namespace.QName REQUESTOPERATION$2 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/edxlrequest", "requestOperation");
    private static final javax.xml.namespace.QName PARAMETERS$4 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/edxlrequest", "parameters");
     ...
     */
    public services.dmopen.fema.gov.edxlrequest.ParameterListItem[] getParametersArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            services.dmopen.fema.gov.edxlrequest.ParameterListItem[] result = new services.dmopen.fema.gov.edxlrequest.ParameterListItem[targetList.size()];
     ...
     */
    public services.dmopen.fema.gov.edxlrequest.ParameterListItem getParametersArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.edxlrequest.ParameterListItem target = null;
            target = (services.dmopen.fema.gov.edxlrequest.ParameterListItem)get_store().find_element_user(PARAMETERS$4, i);
            if (target == null)
            {
     ...
     */
    public void setParametersArray(services.dmopen.fema.gov.edxlrequest.ParameterListItem[] parametersArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setParametersArray(int i, services.dmopen.fema.gov.edxlrequest.ParameterListItem parameters)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public services.dmopen.fema.gov.edxlrequest.ParameterListItem insertNewParameters(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.edxlrequest.ParameterListItem target = null;
            target = (services.dmopen.fema.gov.edxlrequest.ParameterListItem)get_store().insert_element_user(PARAMETERS$4, i);
            return target;
        }
    }
     ...
     */
    public services.dmopen.fema.gov.edxlrequest.ParameterListItem addNewParameters()
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.edxlrequest.ParameterListItem target = null;
            target = (services.dmopen.fema.gov.edxlrequest.ParameterListItem)get_store().add_element_user(PARAMETERS$4);
            return target;
        }
    }
