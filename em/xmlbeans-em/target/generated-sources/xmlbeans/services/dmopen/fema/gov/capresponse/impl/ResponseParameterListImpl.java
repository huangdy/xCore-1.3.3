 ...
 */
public class ResponseParameterListImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements services.dmopen.fema.gov.capresponse.ResponseParameterList
{
    ...
    private static final javax.xml.namespace.QName PARAMETERLISTITEM$0 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/capresponse", "parameterListItem");
    private static final javax.xml.namespace.QName RESPONSEOPERATION$2 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/capresponse", "ResponseOperation");
    private static final javax.xml.namespace.QName RESPONSETYPE$4 = 
        new javax.xml.namespace.QName("http://gov.fema.dmopen.services/capresponse", "ResponseType");
    
    
    /**
     * Gets array of all "parameterListItem" elements
     */
    public services.dmopen.fema.gov.capresponse.ParameterListItem[] getParameterListItemArray()
    {
        synchronized (monitor())
        {
            ...
            services.dmopen.fema.gov.capresponse.ParameterListItem[] result = new services.dmopen.fema.gov.capresponse.ParameterListItem[targetList.size()];
     ...
     */
    public services.dmopen.fema.gov.capresponse.ParameterListItem getParameterListItemArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.capresponse.ParameterListItem target = null;
            target = (services.dmopen.fema.gov.capresponse.ParameterListItem)get_store().find_element_user(PARAMETERLISTITEM$0, i);
            if (target == null)
            {
     ...
     */
    public void setParameterListItemArray(services.dmopen.fema.gov.capresponse.ParameterListItem[] parameterListItemArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setParameterListItemArray(int i, services.dmopen.fema.gov.capresponse.ParameterListItem parameterListItem)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public services.dmopen.fema.gov.capresponse.ParameterListItem insertNewParameterListItem(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.capresponse.ParameterListItem target = null;
            target = (services.dmopen.fema.gov.capresponse.ParameterListItem)get_store().insert_element_user(PARAMETERLISTITEM$0, i);
            return target;
        }
    }
     ...
     */
    public services.dmopen.fema.gov.capresponse.ParameterListItem addNewParameterListItem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            services.dmopen.fema.gov.capresponse.ParameterListItem target = null;
            target = (services.dmopen.fema.gov.capresponse.ParameterListItem)get_store().add_element_user(PARAMETERLISTITEM$0);
            return target;
        }
    }
