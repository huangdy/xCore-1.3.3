 ...
 */
public class GetLogByHostnameResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.uicds.loggingMessage.GetLogByHostnameResponseDocument
{
    ...
    private static final javax.xml.namespace.QName GETLOGBYHOSTNAMERESPONSE$0 = 
        new javax.xml.namespace.QName("http://uicds.org/LoggingMessage", "GetLogByHostnameResponse");
    
    
    /**
     * Gets the "GetLogByHostnameResponse" element
     */
    public org.uicds.loggingMessage.GetLogByHostnameResponseDocument.GetLogByHostnameResponse getGetLogByHostnameResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.uicds.loggingMessage.GetLogByHostnameResponseDocument.GetLogByHostnameResponse target = null;
            target = (org.uicds.loggingMessage.GetLogByHostnameResponseDocument.GetLogByHostnameResponse)get_store().find_element_user(GETLOGBYHOSTNAMERESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetLogByHostnameResponse(org.uicds.loggingMessage.GetLogByHostnameResponseDocument.GetLogByHostnameResponse getLogByHostnameResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.uicds.loggingMessage.GetLogByHostnameResponseDocument.GetLogByHostnameResponse)get_store().add_element_user(GETLOGBYHOSTNAMERESPONSE$0);
            }
     ...
     */
    public org.uicds.loggingMessage.GetLogByHostnameResponseDocument.GetLogByHostnameResponse addNewGetLogByHostnameResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetLogByHostnameResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.uicds.loggingMessage.GetLogByHostnameResponseDocument.GetLogByHostnameResponse
    {
        private static final long serialVersionUID = 1L;
