package com.saic.uicds.testWS.controller;
...
public class ImportXsdSchema implements XsdSchema {
    ...
    private static final QName SCHEMA_NAME = QNameUtils.createQName(
            ImportXsdSchema.SCHEMA_NAMESPACE, "schema", "xsd");
    ...
    /**
     * Create a new instance of the {@link SimpleXsdSchema} class. <p/> A subsequent call to the
     * {@link #setXsd(Resource)} method is required.
     */
