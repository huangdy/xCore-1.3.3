 ...
 */
public class EdxlDeMessageResponseTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.uicds.haveService.EdxlDeMessageResponseType
{
    ...
    private static final javax.xml.namespace.QName ERROREXISTS$0 = 
        new javax.xml.namespace.QName("http://uicds.org/HAVEService", "errorExists");
    ...
    private static final javax.xml.namespace.QName ERRORSTRING$4 = 
        new javax.xml.namespace.QName("http://uicds.org/HAVEService", "errorString");
    private static final javax.xml.namespace.QName COREERROR$6 = 
        new javax.xml.namespace.QName("http://uicds.org/HAVEService", "coreError");
     ...
     */
    public org.uicds.haveService.EdxlDeMessageErrorType[] getCoreErrorArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            org.uicds.haveService.EdxlDeMessageErrorType[] result = new org.uicds.haveService.EdxlDeMessageErrorType[targetList.size()];
     ...
     */
    public org.uicds.haveService.EdxlDeMessageErrorType getCoreErrorArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.uicds.haveService.EdxlDeMessageErrorType target = null;
            target = (org.uicds.haveService.EdxlDeMessageErrorType)get_store().find_element_user(COREERROR$6, i);
            if (target == null)
            {
     ...
     */
    public void setCoreErrorArray(org.uicds.haveService.EdxlDeMessageErrorType[] coreErrorArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setCoreErrorArray(int i, org.uicds.haveService.EdxlDeMessageErrorType coreError)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.uicds.haveService.EdxlDeMessageErrorType insertNewCoreError(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.uicds.haveService.EdxlDeMessageErrorType target = null;
            target = (org.uicds.haveService.EdxlDeMessageErrorType)get_store().insert_element_user(COREERROR$6, i);
            return target;
        }
    }
     ...
     */
    public org.uicds.haveService.EdxlDeMessageErrorType addNewCoreError()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.uicds.haveService.EdxlDeMessageErrorType target = null;
            target = (org.uicds.haveService.EdxlDeMessageErrorType)get_store().add_element_user(COREERROR$6);
            return target;
        }
    }
