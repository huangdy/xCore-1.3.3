...
public interface UICDSConstants {
    ...
    public static final String UICDS = "XchangeCore Explorer";
    ...
    public static final String UICDSExplorer = "XchangeCore v1.3.3 Explorer";
    ...
    public static final String NewConsoleTitle = "New Agreements Console";
    public static final String NewConsoleURL = "/uicds/console";
