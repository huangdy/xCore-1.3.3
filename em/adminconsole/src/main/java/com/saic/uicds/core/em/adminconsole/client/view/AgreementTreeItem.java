...
public class AgreementTreeItem extends TreeItem implements UICDSTreeItem,
		UICDSConstants {
				...
				.getAgreementList(new AsyncCallback<List<AgreementGWT>>() {
					...
					public void onSuccess(List<AgreementGWT> agreementList) {
						...
						for (String agreementID : agreementIDSet) {
							...
							aTree.addItem(ToggleAgreementStatus).setTitle(
									agreementID);
							aTree.addItem(AddRule).setTitle(agreementID);
							aTree.addItem(DeleteRule).setTitle(agreementID);
							aTree.addItem(RescindAgreement).setTitle(
									agreementID);
