...
public class ExplorerTree extends Tree implements UICDSConstants {
	...
	private static String newConsoleURL = null;
	...
	public ExplorerTree(TextArea xmlDocument, final HTML htmlDocument,
		...
		addSelectionHandler(new SelectionHandler<TreeItem>() {
			...
			public void onSelection(SelectionEvent<TreeItem> event) {
				...
				if (selectedItemName.equalsIgnoreCase(IncidentRSSFeed))	return;
				if (selectedItemName.equalsIgnoreCase(NewConsoleTitle))	return;
		...
		addKeyboardListener(new KeyboardListener() {
			...
			public void onKeyPress(Widget arg0, char arg1, int arg2) {
				...
				if (arg1 == KEY_ENTER && text.equalsIgnoreCase(NewConsoleTitle)) {
		...
		addMouseDownHandler(new MouseDownHandler() {
			...
			public void onMouseDown(MouseDownEvent e) {
				...
				if (e.getNativeButton() == NativeEvent.BUTTON_RIGHT) {
					...
					if (selectedItemName != null
												&& selectedItemName
														.equalsIgnoreCase(NewConsoleTitle)) {
											Window.Location.assign(NewConsoleURL);
					}
				}
			}
			...
			BaseController.directoryServiceProxyAsync
					.getRequestUrl(new AsyncCallback<String>() {
						...
						public void onSuccess(String url) {
							...
							newConsoleURL = new String (url + NewConsoleURL);

							// Util.DEBUG("IncidentRssFeedUrl: " +
							// incidentRssFeedUrl);
							// incident rss feed link

							TreeItem consoleAnchor = root.addItem(NewConsoleTitle);
							TreeItem rssAnchor = root.addItem(IncidentRSSFeed);

							consoleAnchor.setStyleName("anchorUnderline");
