...
public class ProfileTreeItem extends TreeItem implements UICDSTreeItem,
		UICDSConstants {
				...
				.getProfileList(new AsyncCallback<List<ProfileGWT>>() {
					...
					public void onSuccess(List<ProfileGWT> profileList) {
						...
						for (String profileID : profileIDSet) {
							...
							TreeItem aTree = addItem(profileID);
							aTree.setTitle(profileID);
							aTree.addItem(UpdateProfile).setTitle(profileID);
							aTree.addItem(RemoveProfile).setTitle(profileID);
							aTree.addItem(AddInterest).setTitle(profileID);
							aTree.addItem(RemoveInterest).setTitle(profileID);
						}
