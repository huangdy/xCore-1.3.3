...
public class DigestGenerator {
   ...
   public DigestGenerator(String xsltFilePath, String iconConfigXmlFilePath) {
    ...
    private ByteArrayOutputStream createDigestFromDoc(IncidentDocument incidentDoc,
        ByteArrayOutputStream baos) {
    ...
    private ByteArrayOutputStream createDigestFromDoc(CommitResourceDocument comResDoc, ByteArrayOutputStream baos)
	{
		javax.xml.transform.Result result = new javax.xml.transform.stream.StreamResult(baos);
		try {
			log.info("comResDoc="+comResDoc.toString());
			javax.xml.transform.Source xmlSource = new javax.xml.transform.dom.DOMSource(
					comResDoc.getDomNode());
			transformer.transform(xmlSource, result);
		} catch (Throwable e) {
			log.error("Transformation failed: " + e.getMessage() + ".");
			e.printStackTrace();
   ...
   private ByteArrayOutputStream createDigestFromDoc(WorkProductDocument wpDoc, ByteArrayOutputStream baos) {
